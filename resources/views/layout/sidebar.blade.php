            ...
            <div class="header-content col px-md-3">
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ml-auto">
                        {{-- <a id="notificationsInvoker" class="header-invoker" href="#" aria-controls="notifications" aria-haspopup="true" aria-expanded="false" data-unfold-event="click" data-unfold-target="#notifications" data-unfold-type="css-animation" data-unfold-duration="300"
        ...
        <aside id="sidebar" class="js-custom-scroll side-nav">
            <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
                ...
                <li class="side-nav-menu-item {{request()->is ('panel/dashboardadmin') ?'active' : ''}}">
                    <a class="side-nav-menu-link media align-items-center " href="/panel/dashboardadmin">
                ...
                <li class="side-nav-menu-item side-nav-has-menu">
                    ...
                    <i class="gd-user"></i>
                        ...
                        <span class="side-nav-fadeout-on-closed media-body">Master Karyawan</span>
                ...
                <i class="gd-angle-right side-nav-fadeout-on-closed"></i>
                    ...
                    <ul id="subUsers" class="side-nav-menu side-nav-menu-second-level mb-0">
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link {{request()->is ('datakaryawan') ?'active' : ''}}" href="/datakaryawan">Data Karyawan</a>
                        </li>
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" href="/datapresensi">Data Presensi</a>
                        </li>
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" href="/datapengajuancuti">Data Pengajuan Cuti</a>
                        </li>
                    </ul>
                ...
                <i class="gd-home"></i>
                        ...
                        <span class="side-nav-fadeout-on-closed media-body">Master Aset</span>
                        <span class="side-nav-control-icon d-flex">
                <i class="gd-angle-right side-nav-fadeout-on-closed"></i>
              </span>
                        <span class="side-nav__indicator side-nav-fadeout-on-closed"></span>
                    ...
                    <ul id="subPages" class="side-nav-menu side-nav-menu-second-level mb-0">
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" href="/dataruangan">Data Ruangan</a>
                        </li>
                        {{-- <li class="side-nav-menu-item">
                ...
                <i class="gd-home"></i>
                        ...
                        <span class="side-nav-fadeout-on-closed media-body">Data Aset</span>
                    </a>
                </li>
                <!-- End Settings -->
